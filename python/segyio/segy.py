...
class SegyFile(object):
    ...
    def bin(self):
        ...
        segyio.BinField : header field enumerator
        segyio.su : Seismic Unix names for header fields
